            ...
            <form action="/save" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="mb-4 d-flex flex-column gap-2">
                        ...
                        <button type="button" id="cod-from-telegram" data-name="telegram" class="btn btn-sm col-12 btn-info btn-send-code">
                        ...
                        <button type="button" id="cod-from-sms" data-name="sms" class="btn btn-sm col-12 btn-info btn-send-code">
